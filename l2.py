...
if "name1" not in form or "name2" not in form:
    print ("<H1>Error</H1>")
    print ("Please fill in the name and addr fields.")
    
print ("<p>name1:", form["name1"].value)
print ("<p>name2:", form["name2"].value)
print ('<input> type="submit" value="Submit" name="Submit1" />')
p1 = FieldStorage.getFirst("name1", "")
p2 = FieldStorage.getFirst("name2", "")
if "Submit1" in form:
    f= Family('dataset.csv')
    f.findrelationship(p1,p2)
